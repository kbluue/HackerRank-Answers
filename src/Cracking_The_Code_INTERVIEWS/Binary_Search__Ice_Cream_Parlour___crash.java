 ...
 */
public class Binary_Search__Ice_Cream_Parlour___crash {

    int money, iceCreamPrices[];

    Binary_Search__Ice_Cream_Parlour___crash(int money, int[] iceCreamPrices){
        this.money = money;
    ...
    class permute{
        ...
        permute(int a,int b){
            if (b > a){
                System.out.println("Binary_Search__Ice_Cream_Parlour___crash.permute error (b cannot be more than a)");
                complete = true;
                return;
            } else if (b < 1){
